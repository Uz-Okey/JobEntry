  ...
  return (
    ...
    >
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        {/* Menu items */}
        <div className={`${isOpen ? 'block bg-white' : 'hidden'} w-full md:block md:w-auto`} id="navbar-dropdown">
          ...
          md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-transparent">
            ...
            <li className="relative group">
              <button
                ...
                className="flex cursor-pointer items-center justify-between w-full py-2 px-3 text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:hover:text-green-700 md:p-0 md:w-auto"
              >
                Jobs
              ...
              {dropdown && (
                <div className="absolute left-0 w-44 bg-white divide-y divide-gray-100 rounded-lg shadow-lg dark:bg-gray-700">
                  <ul className="py-2 text-sm text-gray-700 dark:text-gray-400">
                    ...
                    <li><Link to="/settingspage" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Available Jobs</Link></li>
                  </ul>
                  <div className="py-1">
          ...
          <div className="flex md:hidden">
            <button
              type="button"
              className="focus:outline-none text-white bg-green-700 hover:bg-green-800 hover:buttonbg focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 cursor-pointer buttonbg border-2 hover:text-black"
            >
              Login
            </button>
            <button
              type="button"
              className="text-green-700 bg-white border cursor-pointer border-green-700 focus:outline-none hover:bg-green-700 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 hover:text-white"
            >
              Sign in
            </button>
          </div>
