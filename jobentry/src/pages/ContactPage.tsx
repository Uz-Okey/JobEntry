...
const ContactPage = () => {
  return (
            ...
            <div className="hs-carousel-slide overflow-hidden w-screen h-screen">
              <div className="flex overflow-hidden justify-center items-center w-full h-[80%] dark:bg-neutral-900">
                ...
                <div className="absolute text-white font-bold justify-end text-center  flex gap-5">
                  <Link to="/" className="buttonbg rounded-sm py-1 px-4 border-2">Home</Link>
                  <Link to="/servicepage" className="buttonbg px-4 py-1 rounded-sm border-2">Service</Link>
                  <Link to="/dashboardpage" className="buttonbg px-4 py-1 rounded-sm border-2">Jobs</Link>
                </div>
              </div>
            </div>
          </div>
   ...
   <h1
                ...
                className={ `duration-700 transition-all ease-in-out 'opacity-100 translate-y-0':'translate-y-20 opacity-0' text-center mb-10 text-2xl md:text-[40px] text-green-700 font-bold`}
            >Contact Us</h1>

<form className="max-w-sm mv-5 mx-auto">
  <div className="mb-5">
  ...
  <div className="flex items-start mb-5">
    ...
    <label for="terms" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">I agree with the <a href="#" className="text-green-700 hover:underline dark:text-green-700">terms and conditions</a></label>
...
<div>
  <a
    ...
    className="inline-block px-2 mb-5 py-1 bg-green-300 text-green-700 font-semibold rounded-sm shadow hover:bg-green-600 hover:text-white transition-colors"
  >
    Chat on WhatsApp
  </a>
</div>

  <button type="submit" className="text-white bg-green-700 cursor-pointer mb-5 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-600 dark:focus:ring-green-700">Submit</button>
</form>
